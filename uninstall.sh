...
echo "[3/4] Removing ble.sh (data + cache)"
rm -rf "$BLESH_DIR" "$HOME/.cache/blesh"
...
Open a new terminal to drop the prompt customizations — running shells
keep ble.sh and Starship loaded until they exit.
